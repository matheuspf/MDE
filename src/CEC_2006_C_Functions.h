//
// Created by matheus on 3/25/17.
//

#ifndef BRKGA_CEC_2006_C_FUNCTIONS_H_H
#define BRKGA_CEC_2006_C_FUNCTIONS_H_H
...
namespace de
{
    ...
    namespace CEC_2006
    {
        ...
        void
        g01 (double *x, double *f, double *g, double *h, int nx)
        {
            int j;
        ...
        void
        g02 (double *x, double *f, double *g, double *h, int nx)
        {
            int j;
        ...
        void
        g03 (double *x, double *f, double *g, double *h, int nx)
        {
            int j;
        ...
        void
        g04 (double *x, double *f, double *g, double *h, int nx)
        {
            /* objective function */
        ...
        void
        g05 (double *x, double *f, double *g, double *h, int nx)
        {
            /* objective function */
        ...
        void
        g06 (double *x, double *f, double *g, double *h, int nx)
        {
            /* objective function */
        ...
        void
        g07 (double *x, double *f, double *g, double *h, int nx)
        {
            /* objective function */
            f[0] =
        ...
        void
        g08 (double *x, double *f, double *g, double *h, int nx)
        {
...
/* constraints */
        ...
        void
        g09 (double *x, double *f, double *g, double *h, int nx)
        {
            /* objective function */
            f[0] =
        ...
        void
        g10 (double *x, double *f, double *g, double *h, int nx)
        {
            /* objective function */
            f[0] = x[0] + x[1] + x[2];
            /* constraints g<=0 */
        ...
        void
        g11 (double *x, double *f, double *g, double *h, int nx)
        {
            /* objective function */
        ...
        void
        g12 (double *x, double *f, double *g, double *h, int nx)
        {
            double gt;
            int i, j, k;
...
/* constraints */
        ...
        void
        g13 (double *x, double *f, double *g, double *h, int nx)
        {
            /* objective function */
        ...
        void
        g14 (double *x, double *f, double *g, double *h, int nx)
        {
            int i;
        ...
        void
        g15 (double *x, double *f, double *g, double *h, int nx)
        {
            /* objective function */
        ...
        void
        g16 (double *x, double *f, double *g, double *h, int nx)
        {
        ...
        void
        g17 (double *x, double *f, double *g, double *h, int nx)
        {
        ...
        void
        g18 (double *x, double *f, double *g, double *h, int nx)
        {
            /* objective function */
        ...
        void
        g19 (double *x, double *f, double *g, double *h, int nx)
        {
            int i, j;
        ...
        void
        g20 (double *x, double *f, double *g, double *h, int nx)
        {
        ...
        void
        g21 (double *x, double *f, double *g, double *h, int nx)
        {
            int i;
        ...
        void
        g22 (double *x, double *f, double *g, double *h, int nx)
        {
            int i;
        ...
        void
        g23 (double *x, double *f, double *g, double *h, int nx)
        {
            int i;
        ...
        void
        g24 (double *x, double *f, double *g, double *h, int nx)
        {
            /* objective function */
            f[0] = -x[0] - x[1];
            /* constraint function */
...
#endif //BRKGA_CEC_2006_C_FUNCTIONS_H_H
